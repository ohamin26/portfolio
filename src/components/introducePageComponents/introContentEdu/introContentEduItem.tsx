      ...
      {text === 'highscool' && (
        <div className={introContentEduItem}>
          ...
          <div className={introContentEduItemTitle}>
            ...
            <span className={introContentEduItemLink}>https://hansei.sen.hs.kr/</span>
          </div>
      ...
      {text === 'college' && (
        <div className={introContentEduItem}>
          ...
          <div className={introContentEduItemTitle}>
            ...
            <span className={introContentEduItemLink}>https://www.tukorea.ac.kr/tukorea/index.do</span>
          </div>
      ...
      {text === 'gdsc' && (
        <div className={introContentEduItem}>
          ...
          <div className={introContentEduItemTitle}>
            ...
            <span className={introContentEduItemLink}>https://gdsc.community.dev/tech-university-of-korea/</span>
          </div>
